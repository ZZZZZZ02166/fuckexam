...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      study_stages: {
        Row: { estimated_minutes: number | null; id: string; key_concepts: string[]; material_types: string[] | null; module_order: number | null; name: string; prerequisite_concepts: string[]; review_concepts: string[]; source_file_name: string | null; source_material_id: string | null; stage_order: number; status: string | null; subject_id: string; test_types: string[] | null; topic_ids: string[] | null }
        Insert: { estimated_minutes?: number | null; id?: string; key_concepts?: string[]; material_types?: string[] | null; module_order?: number | null; name: string; prerequisite_concepts?: string[]; review_concepts?: string[]; source_file_name?: string | null; source_material_id?: string | null; stage_order: number; status?: string | null; subject_id: string; test_types?: string[] | null; topic_ids?: string[] | null }
        Update: { estimated_minutes?: number | null; id?: string; key_concepts?: string[]; material_types?: string[] | null; module_order?: number | null; name?: string; prerequisite_concepts?: string[]; review_concepts?: string[]; source_file_name?: string | null; source_material_id?: string | null; stage_order?: number; status?: string | null; subject_id?: string; test_types?: string[] | null; topic_ids?: string[] | null }
